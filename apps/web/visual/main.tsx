...
const routes: Record<string, string> = {
  login: '/login', 'login-auth-methods': '/login', overview: '/', assets: '/hosts', 'host-card': '/hosts?host=host-1', 'host-detail': '/hosts/host-1', agents: '/agents', 'agents-policy': '/agents', vulnerabilities: '/vulnerabilities', 'vulnerability-investigation': '/vulnerabilities', 'vulnerability-investigation-exposures': '/vulnerabilities', evidence: '/evidence', administration: '/settings/users',
}
const user = surface.startsWith('login') ? null : {
