...
const tooltipStyle = { background: '#fbfaf6', border: '1px solid #d2cabd', borderRadius: 6, color: '#302d28', fontFamily: 'var(--font-main)', fontSize: 11, boxShadow: '0 14px 36px rgba(63, 50, 34, .16)' }
