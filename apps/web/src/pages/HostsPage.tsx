...
export function HostsPage() {
  ...
  const columns: SecurityColumn<Host>[] = [
    ...
    { id: 'last_seen', header: 'Last seen', priority: 'detail', sortValue: (host) => host.last_scan_at ?? '', exportValue: (host) => host.last_scan_at, cell: (host) => <span className="font-mono text-[10px] text-slate-400">{formatDateTime(host.last_scan_at)}</span> },
  ]
