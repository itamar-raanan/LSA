  ...
  return <div className="page-reveal how-to-page">
    ...
    <section id="features" className="how-to-section" aria-labelledby="features-title">
      ...
      <div className="feature-directory">
        ...
        <article><Package size={20} weight="duotone" /><div><h3>Correlate Applications And CVEs</h3><p>Use Applications for software inventory and Vulnerabilities for severity, affected hosts, fixed versions, OSV advisories, and CISA KEV priority.</p><Link to="/vulnerabilities">Review Vulnerabilities <ArrowRight size={13} /></Link></div></article>
