...
describe('ApplicationsPage', () => {
  it('summarizes software and correlates versions with affected hosts', async () => {
    render(<AuthContext.Provider value={{ user: { id: 'user-1', email: 'admin@example.test', name: 'Admin', role: 'admin' }, login: vi.fn(), radiusLogin: vi.fn(), acceptSession: vi.fn(), logout: vi.fn() }}><MemoryRouter><ApplicationsPage /></MemoryRouter></AuthContext.Provider>)
