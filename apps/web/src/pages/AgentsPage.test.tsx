...
describe('Agents', () => {
  ...
  it('opens with all hosts and scopes categorized policy controls by group', async () => {
    ...
    expect(screen.getByRole('combobox', { name: 'Policy section' })).toBeInTheDocument()
    fireEvent.change(screen.getByRole('combobox', { name: 'Policy section' }), { target: { value: 'filesystem' } })
