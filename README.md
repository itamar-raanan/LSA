...
| **Network** | Outbound TCP 8444 to the LSA agent gateway | Reliable DNS and time synchronization; agent 0.11.0 encrypts HTTPS traffic and authenticates platform control responses with a pinned Ed25519 identity, but does not validate the gateway certificate or hostname |
